...
function selectEmployeeToEval() {
    ...
    document.getElementById("q-0").textContent = `${mySelect.value} personality and charisma is truly magnetic.`;
    document.getElementById("q-1").textContent = `${mySelect.value} is a person of charisma and influence.`;
    document.getElementById("q-2").textContent = `${mySelect.value} is a very soft spoken person and never lose his temper.`;
    document.getElementById("q-3").textContent = `${mySelect.value} dress and personal appearance.`;
    document.getElementById("q-4").textContent = `${mySelect.value} is accountable for her tasks.`;
    document.getElementById("q-5").textContent = `${mySelect.value} behavior according to the company’s ethical code.`;
    document.getElementById("q-6").textContent = `${mySelect.value}  the employee demonstrated the highest level of understanding of
      the most complex design and implementation issues at every stage
      of development.`;
    document.getElementById("q-7").textContent = `${mySelect.value} has an exceptional way of finding things and get them
      improved.`;
    document.getElementById("q-8").textContent = `${mySelect.value} understands complicated issues, even when outside of
